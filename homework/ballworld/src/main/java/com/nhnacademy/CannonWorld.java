...
public class CannonWorld extends MovableWorld implements MouseMotionListener, KeyListener, ComponentListener {
    ...
    public CannonWorld(int x, int y, int width, int height) {
        ...
        obstacle = new BounceableBox(width/2, height, 300, 200, Color.BLACK);
        add(obstacle);
    ...
    public void setTarget() {
        target = new BrittleBox(1000, 500, 200, 400, Color.YELLOW);
        add(target);
        target.setHitListener(other -> remove(target));
    }
}
